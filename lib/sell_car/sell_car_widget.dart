...
export 'sell_car_model.dart';

class SellCarWidget extends StatefulWidget {
  const SellCarWidget({super.key});

  @override
  State<SellCarWidget> createState() => _SellCarWidgetState();
}

class _SellCarWidgetState extends State<SellCarWidget> {
  late SellCarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SellCarModel());
